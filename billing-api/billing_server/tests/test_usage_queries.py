...
class Test(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.database.close()
    # This test has been out of date
    ...
    #     self.assertEqual('Articuno', self.database.get_username(user_id_1))
    #     self.assertEqual('Zapdos', self.database.get_username(user_id_2))

    def test_invalid_username(self):
        user_id_3 = '333'
        self.assertEqual('Unknown User <333>',
                          self.database.get_username(user_id_3))
    ...
    def test_instance_core_hours_created_and_deleted_in_date_range_one_user(self):
        ...
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id, 4,
                        '2016-09-12 04:39:13', '2016-09-28 16:48:19')
        data = self.database.get_instance_core_hours('2016-09-10 00:00:00',
                                                     '2016-09-30 15:00:00',
                                                     [project_id],
                                                     [''],
                                                     user_id)
        self.assertEqual(1588, data[0]['cpu'])
    ...
    def test_instance_core_hours_created_and_deleted_out_of_date_range_one_user(self):
        ...
        create_user(self.database, user_id, 'Cool Guy')
        assign_role(self.database, user_id, project_id)
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id,
                        4, '2016-09-12 04:39:13', None)
        data = self.database.get_instance_core_hours('2016-09-15 00:00:00',
                                                     '2016-09-26 15:00:00',
                                                     [project_id],
                                                     [''],
                                                     user_id)
        self.assertEqual(1116, data[0]['cpu'])
    ...
    def test_instance_core_hours_created_in_and_deleted_out_of_date_range_one_user(self):
        ...
        data = self.database.get_instance_core_hours('2016-09-10 00:00:00',
                                                     ...
                                                     [''],
                                                     user_id)
        self.assertEqual(1388, data[0]['cpu'])
    ...
    def test_instance_core_hours_created_out_and_deleted_in_date_range_one_user(self):
        ...
        data = self.database.get_instance_core_hours('2016-09-15 00:00:00',
                                                     ...
                                                     [''],
                                                     user_id)
        self.assertEqual(1316, data[0]['cpu'])
    ...
    def test_instance_core_hours_sum_all_cases_one_user(self):
        ...
        assign_role(self.database, user_id, project_id)
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id, 4,
                        '2016-09-12 04:39:13', '2016-09-20 16:48:19')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id, 8,
                        '2016-09-01 04:39:13', '2016-09-30 16:48:19')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id, 2,
                        '2016-09-01 04:39:13', '2016-09-18 12:35:11')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id, project_id, 1,
                        '2016-09-17 00:39:13', '2016-09-30 16:48:19')
        data = self.database.get_instance_core_hours('2016-09-10 10:00:00',
                                                     '2016-09-25 15:00:00',
                                                     [project_id],
                                                     [''],
                                                     user_id)
        self.assertEqual(820+2920+390+207, data[0]['cpu'])
    ...
    def test_volume_gigabyte_hours_created_and_deleted_in_date_range_one_user(self):
        ...
        create_user(self.database, user_id, 'Cool Guy')
        assign_role(self.database, user_id, project_id)
        create_volume(self.database, user_id, project_id, 64,
                      '2016-09-24 19:40:23', '2016-10-05 20:10:29')
        data = self.database.get_volume_gigabyte_hours('2016-09-10 10:00:00',
                                                       '2016-10-25 15:00:00',
                                                       [project_id],
                                                       [''],
                                                       user_id)
        self.assertEqual(16960, data[0]['volume'])
    ...
    def test_volume_gigabyte_hours_created_and_deleted_outside_date_range_one_user(self):
        ...
        create_user(self.database, user_id, 'Cool Guy')
        assign_role(self.database, user_id, project_id)
        create_volume(self.database, user_id, project_id, 128,
                      '2016-09-24 19:40:23', '2016-10-05 20:10:29')
        data = self.database.get_volume_gigabyte_hours('2016-09-30 10:00:00',
                                                       ...
                                                       [''],
                                                       user_id)
        self.assertEqual(9856, data[0]['volume'])
    ...
    def test_volume_gigabyte_hours_created_in_and_deleted_out_of_date_range_one_user(self):
        ...
        create_user(self.database, user_id, 'Cool Guy')
        assign_role(self.database, user_id, project_id)
        create_volume(self.database, user_id, project_id,
                      32, '2016-09-24 19:40:23', None)
        data = self.database.get_volume_gigabyte_hours('2016-09-10 10:00:00',
                                                       '2016-10-25 15:00:00',
                                                       [project_id],
                                                       [''],
                                                       user_id)
        self.assertEqual(23680, data[0]['volume'])
    ...
    def test_volume_gigabyte_hours_created_out_of_and_deleted_in_date_range_one_user(self):
        ...
        data = self.database.get_volume_gigabyte_hours('2016-09-26 18:20:00',
                                                       ...
                                                       [''],
                                                       user_id)
        self.assertEqual(13952, data[0]['volume'])
    ...
    def test_volume_gigabyte_hours_sum_all_cases_one_user(self):
        ...
        create_user(self.database, user_id, 'Cool Guy')
        assign_role(self.database, user_id, project_id)
        create_volume(self.database, user_id, project_id, 4,
                      '2016-09-12 04:39:13', '2016-09-20 16:48:19')
        create_volume(self.database, user_id, project_id, 8,
                      '2016-09-01 04:39:13', '2016-09-30 16:48:19')
        create_volume(self.database, user_id, project_id, 2,
                      '2016-09-01 04:39:13', '2016-09-18 12:35:11')
        create_volume(self.database, user_id, project_id, 1,
                      '2016-09-17 00:39:13', '2016-09-30 16:48:19')
        data = self.database.get_volume_gigabyte_hours('2016-09-10 10:00:00',
                                                       '2016-09-25 15:00:00',
                                                       [project_id],
                                                       [''],
                                                       user_id)
        self.assertEqual(820 + 2920 + 390 + 207, data[0]['volume'])
    ...
    def test_get_usage_statistics_groups_by_user_and_project(self):
        ...
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_1, project_id_1,
                        4, '2016-09-04 16:42:13', '2016-11-30 23:14:00')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_1, project_id_2,
                        2, '2016-10-02 22:15:59', '2016-10-31 00:00:00')

        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_2, project_id_1,
                        8, '2016-09-15 12:04:32', '2016-10-07 19:53:23')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_2, project_id_2,
                        1, '2016-09-28 00:00:00', '2016-09-28 00:00:01')
        ...
        data = self.database.get_instance_core_hours('2016-09-23 00:00:00',
                                                     ...
                                                     [''],
                                                     user_id_1)
        self.assertEqual(4, data.__len__())
        case11 = False
        case12 = False
        case21 = False
        case22 = False
    ...
    def test_user_can_only_see_own_usage_if_no_billing_projects(self):
        ...
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_1, project_id, 4,
                        '2016-09-04 16:42:13', '2016-11-30 23:14:00')
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_2, project_id, 8,
                        '2016-09-15 12:04:32', '2016-10-07 19:53:23')
        data = self.database.get_instance_core_hours('2016-09-23 00:00:00',
                                                     '2016-10-20 00:00:00',
                                                     [''],
                                                     [project_id],
                                                     user_id_1)
        self.assertEqual(1, data.__len__())
        self.assertEqual(user_id_1, data[0]['user'])
    ...
    def test_user_with_multiple_roles(self):
        ...
        data = self.database.get_instance_core_hours('2016-09-23 00:00:00',
                                                     ...
                                                     [project_id_2],
                                                     user_id_1)
        self.assertEqual(3, data.__len__())
        case11 = False
        case12 = False
        case21 = False
        for row in data:
            ...
            if row['user'] == user_id_2 and row['projectId'] == project_id_2:
                self.fail(
                    "User 1 should not be able to see the usage of User 2 in Project 2")
    ...
    def test_query_usage_returns_data_for_deleted_user(self):
        ...
        create_instance('eb0eb5f8-2c13-464c-8bea-aa74d09ec00f',self.database, user_id_2, project_id, 5,
                        '2016-11-01 00:00:00', '2016-11-01 01:00:00')
